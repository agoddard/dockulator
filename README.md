...
* Poller: [Ruby](http://ruby-lang.org) -- Looks for empty calculations and passes them off to Docker
...
The poller performs a query to Mongdb for all calculations that have a processed flag of "false", there are two possible methods of implementing it 'interactive' and 'daemon'
####interactive 
